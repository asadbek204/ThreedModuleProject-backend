...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('responsibility', models.CharField(max_length=32, verbose_name='responsibility')),
                ('salary', models.PositiveIntegerField(verbose_name='salary')),
                ('manager', models.ManyToManyField(blank=True, null=True, related_name='employees', to='account.employee', verbose_name='manager')),
